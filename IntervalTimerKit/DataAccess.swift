...
public class DataAccess: NSObject {
    ...
    public lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let containerPath = NSFileManager.defaultManager().containerURLForSecurityApplicationGroupIdentifier("group.yuki.yoshinaga.IntervalTimer.CoreData")?.path
        let sqlitePath = NSString(format: "%@/%@", containerPath!, "IntervalTimer")
