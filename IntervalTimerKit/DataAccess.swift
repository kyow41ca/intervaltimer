...
public class DataAccess: NSObject {
    ...
    public lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "IntervalTimer", withExtension: "momd")!
    ...
    public lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("IntervalTimer.sqlite")
